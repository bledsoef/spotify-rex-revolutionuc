...
with Session(engine) as session:
    ...
    testReview1 = Review(id=1, createdBy="testUser2", rec_id=5, dateCreated=datetime(2024, 2, 14), comment="This is so cool", rating=5)
    testReview2 = Review(createdBy="testUser2", rec_id=3, dateCreated=datetime(3, 4, 5), comment="test review", rating=5)
    session.add_all([testUser1, testUser2, testRec, testRec2, testReview1, testReview2, testRec3, testRec4, testRec5])
    session.commit()