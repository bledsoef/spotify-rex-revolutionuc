...
with Session(engine) as session:
    ...
    testPending = Rec(mediaName="See You Again", artistName="Wiz Khalifa", description="description", createdBy="finn", sentTo="steve", isPost=False, status="pending", image="/songs_covers/seeyouagain.jpg")
    testAccepted = Rec(mediaName="Black Beatles", artistName="Rae Srummrand", description="description", createdBy="finn", sentTo="steve", isPost=False, status="accepted", image="/songs_covers/blackbeatles.jpg")
    testCompleted = Rec(mediaName="Girls Like You", artistName="Maroon 5", description="description", createdBy="finn", sentTo="steve", isPost=False, status="completed", image="/songs_covers/girlslikeyou.jpg")
    ...
    testPost = Rec(mediaName="Red", artistName="Taylor Swift", description="description", createdBy="steve", sentTo=None, isPost=True, status="pending", image="/songs_covers/red.jpg")
