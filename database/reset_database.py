...
with Session(engine) as session:
    ...
    testPending = Rec(name="test", createdBy="finn", sentTo="steve", isPost=False, status="pending")
    testAccepted = Rec(name="test2", createdBy="finn", sentTo="steve", isPost=False, status="accepted")
    testCompleted = Rec(name="test2", createdBy="finn", sentTo="steve", isPost=False, status="completed")
    testPost = Rec(name="test3", createdBy="finn", sentTo=None, isPost=True, status="pending")
    testAcceptedPost = Rec(name="test4", createdBy="finn", sentTo="steve", isPost=True, status="accepted")
